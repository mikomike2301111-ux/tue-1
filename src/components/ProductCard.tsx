  ...
  return (
    ...
    >
      <div className="aspect-square bg-gray-100 overflow-hidden relative">
        ...
        {isHovering && (
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent animate-fade-in flex flex-col justify-between p-4">
            <div className="text-white text-sm">
              {product.description && (
                <p className="line-clamp-2 text-gray-100">{product.description}</p>
              )}
            </div>
